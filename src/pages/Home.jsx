    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['WHERE DAMAGE ', 'DISAPPEARS', ' COMPLETELY.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                ...
                style={{
                  ...
                  fontWeight: line === 'DISAPPEARS' ? 700 : 300,
                }}
              >
                {line}
              </h1>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Panel & Body Centre &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['COLLISION REPAIR', 'SPRAY PAINTING', 'DENT REMOVAL', 'INSURANCE CLAIMS', 'DETAILING', 'FRAME WORK'];
...
function ServicesGrid() {
  ...
  const serviceImages = ['https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=800&q=80', 'https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=800&q=80', 'https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=800&q=80', 'https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=800&q=80', 'https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=800&q=80', 'https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=800&q=80'];
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Panel & Body Centre showcase"
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Insurance Approved', desc: 'Authorized repair centre for all major insurance companies in Zimbabwe.' },
    { title: 'Precision Equipment', desc: 'Climate-controlled spray booth and computerized frame measurement for factory-perfect results.' },
    { title: 'Skilled Technicians', desc: 'Our team includes certified panel beaters and spray painters with decades of combined experience.' },
    { title: 'Fast Turnaround', desc: 'Most repairs completed within 48 hours without compromising on quality or attention to detail.' }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              ...
              alt="Panel & Body Centre quality work"
              className="w-full aspect-[4/5] object-cover object-center"
              loading="lazy"
            />
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">Panel</span>
            </h2>
